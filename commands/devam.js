...
module.exports = {
    ...
    run: async (client, interaction) => {
        if(!interaction.member.permissions.has('MANAGE_SUB_TITLES') &&  !interaction.member.roles.cache.has(client.config.çekilişsorumlusu)){
            return interaction.reply({
                content: ':x: Çekiliş yapabilmen için ALT_BAŞLIKLARI_YÖNET yetkisine sahip olmalısın.',
                ephemeral: true
            });
        }
